...
import { X, MessageSquare, Star, Share2, Map, Navigation } from 'lucide-react';
...
export const ItineraryDetailModal = ({ itinerary, onClose, onSave, onShare, userCity, allowEdit = false }: ItineraryDetailModalProps) => {
          ...
          <div className="bg-orange-50 dark:bg-orange-900/10 p-4 border-b border-orange-100 dark:border-orange-900/30 animate-in slide-in-from-top-2">
            <div className="flex gap-2">
              ...
              <button 
                ...
                disabled={isLoading}
                className="bg-orange-600 hover:bg-orange-700 text-white px-4 py-2 rounded-xl text-sm font-bold disabled:opacity-50"
              >
                {isLoading ? '...' : 'Update'}
              </button>
            </div>
