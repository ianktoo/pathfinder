    ...
    <div className="min-h-screen bg-stone-50 dark:bg-neutral-950 flex flex-col">
      ...
      <div className="flex-1 max-w-4xl mx-auto px-6 py-12 w-full">
        <div className="bg-white dark:bg-neutral-900 p-8 rounded-3xl shadow-sm border border-stone-200 dark:border-neutral-800 space-y-8">
          ...
          <section>
            <h2 className="text-xl font-black text-stone-900 dark:text-white mb-4">3. User Rights & Compliance</h2>
            <div className="bg-stone-50 dark:bg-neutral-800/50 p-6 rounded-xl border border-stone-100 dark:border-neutral-800 mb-6">
              <p className="text-stone-600 dark:text-stone-400 mb-4">
                We respect your data sovereignty regardless of your location. Our platform is built to be compliant with major global regulations including <strong>GDPR (Europe)</strong> and <strong>CCPA (California)</strong>.
              </p>
              <ul className="list-disc pl-5 space-y-2 text-stone-600 dark:text-stone-400 leading-relaxed text-sm">
                <li><strong>Right to Access:</strong> You can download a machine-readable JSON copy of all your data at any time.</li>
                <li><strong>Right to Erasure:</strong> You can permanently delete your account and all associated data instantly.</li>
                <li><strong>Right to Know:</strong> We clearly disclose all third-party AI processors used (Google Gemini).</li>
              </ul>
            </div>
          </section>

          <section>
            <h2 className="text-xl font-black text-stone-900 dark:text-white mb-4">4. Data Deletion</h2>
